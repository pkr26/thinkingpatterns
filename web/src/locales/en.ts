...
export const en: Record<string, string> = {
  ...
  "settings.recoveredNone": "Nothing to recover.",
  ...
  "settings.rejectedOne": "{count} recovered entry held back after server refusals.",
  "settings.rejectedMany": "{count} recovered entries held back after server refusals.",
  ...
  // the t() seam — English values are the previously shipped copy, kept
  // verbatim; the es catalog mirrors each key.
  ...
  "app.noticeExpired": "Your session ended — the token expired, or the password was changed / signed out on another device. Sign in again.",
  "app.noticeDeleted": "This account was deleted.",
  "app.noticeRotatedElsewhere": "Your password was changed on another device and your journal was re-encrypted — sign in again with the new password.",
  "app.freshnessNote": "Your pattern data failed its freshness check — it may have been replayed. Pull again in a moment.",
  "common.loading": "Loading…",
  "common.close": "Close",
  "common.sessionLocked": "Your session locked — sign in again.",
  "crisis.webTitle": "Get help now",
  "crisis.webImmediate": "If you are in immediate danger, call 911 (or your local emergency number).",
  "crisis.web988": "988 Suicide & Crisis Lifeline (US): call or text 988 — free, confidential, any hour, any day.",
  "crisis.webTextLine": "Crisis Text Line: text HOME to 741741 (US, CA, UK, IE).",
  ...
  "entry.leanLighter": "lighter",
  "entry.leanHeavier": "heavier",
  "entry.leanEven": "even",
  "entry.showDetailsWeb": "Add details (mood, sleep, energy, tags)",
  "entry.detailsNote": "Details are optional and travel inside the entry's encryption — the server sees only ciphertext.",
  "entry.saving": "Saving…",
  "entry.couldNotSave": "Could not save — try again.",
  "entry.draftMemoryNote": "Drafts live in this tab's memory only — nothing readable is stored.",
  "entry.offlineQueueNote": "Offline — the entry will queue, encrypted, and sync when you're back.",
  "errors.sessionEndedWeb": "Your session ended — sign in again.",
  "history.calendarTitle": "Mood calendar",
  "history.calendarNote": "Each tile is the day's mood — your explicit check-in pick when you made one, otherwise the on-device read of that day's entry. Computed locally, never synced separately.",
  "history.title": "History",
  "history.search": "Search",
  "history.searchPlaceholderWeb": "Search your words, or an exact date (YYYY-MM-DD)",
  "history.hiddenOne": "{count} entry could not be verified and was hidden — it may have been tampered with.",
  "history.hiddenMany": "{count} entries could not be verified and were hidden — they may have been tampered with.",
  "history.rollbackOne": "{count} hidden by the rollback guard.",
  "history.rollbackMany": "{count} hidden by the rollback guard.",
  "history.loadOffline": "Could not load history — check your connection and try again.",
  "history.loadFailed": "Could not load history.",
  "history.noMatch": "No entries match that search.",
  "history.empty": "No entries yet — today is a fine day to start.",
  "history.noRead": "no read",
  "history.editedTimes": "edited ×{count}",
  "history.edit": "Edit",
  "history.editTitle": "Edit {date}",
  "history.yourEntry": "Your entry",
  "history.saveEdit": "Save edit",
  "history.editFailed": "Could not save the edit.",
  "history.conflictReloadFailed": "This entry changed on another device and could not be reloaded — copy your text, then reload.",
  "history.deletedElsewhere": "(this entry was deleted on another device)",
  "history.conflictTitle": "This entry changed on another device",
  "history.conflictTheirs": "Their version (saved first):",
  "history.conflictMine": "Your version:",
  "history.keepTheirs": "Keep their version",
  "history.applyMine": "Apply mine on top",
  "history.noOverwriteNote": "Nothing was overwritten automatically — you choose.",
  "history.deleteFailed": "Could not delete the entry.",
  "insights.titleWeb": "Patterns",
  "insights.baselineReading": "Reading your baseline…",
  "insights.baselineProgress": "Building your baseline: {active} active day{activeUnit}, {remaining} to go before patterns surface.",
  "insights.localTrendA11y": "Your local mood trend",
  "insights.baselineNote": "This trend is computed on this device from your entries and is never synced. Patterns need 30 active days — honest data takes time.",
  "insights.activeIntro": "Observations, not verdicts — computed only from your own writing. Every card shows its evidence.",
  "insights.mutedCountOne": "{count} pattern muted — they stay muted on this browser and in future analyses after your next refresh.",
  "insights.mutedCountMany": "{count} patterns muted — they stay muted on this browser and in future analyses after your next refresh.",
  "insights.unmuteLabel": "Unmute: {label}",
  "insights.privatePattern": "a private pattern",
  "insights.sensitiveTitle": "A difficult thought has been returning",
  "insights.sensitiveBodyWeb": "Something heavy shows up repeatedly in your writing. It is not quoted here — you deserve to decide when to look at it.",
  "insights.evidencePrefix": "evidence",
  ...
  "insights.thresholdNotice": "Your patterns are live — thirty honest days of data, computed only from your own writing. Every card shows its evidence.",
  "insights.freshnessWeb": "Your pattern data failed its freshness check — it may have been replayed. Try again in a moment.",
  "insights.offlineWeb": "Offline — patterns need a connection to refresh.",
  "insights.summaryFailedWeb": "Could not read your pattern summary.",
  "insights.decryptFailedWeb": "Your pattern data could not be decrypted.",
  "insights.methodFallbackWeb": "Computed within your own journal, against your own baseline.",
  "insights.stateWeb.confirmed": "established",
  "insights.webmethod.temporal": "Compared how often this word appears on each weekday against your own writing schedule, with multiple-testing correction across every claim.",
  "insights.webmethod.mood_correlation": "Compared your mood on days this appears versus days it doesn't — always against your own baseline, never anyone else's.",
  "insights.webmethod.link": "Compared how you write the DAY AFTER this appears against your own baseline days.",
  "insights.webmethod.inertia": "Measured how strongly your mood carries over from one day to the next, compared with your own earlier norm.",
  "insights.webmethod.energy_inertia": "Measured how strongly your energy carries over day to day, compared with your own earlier norm.",
  "insights.webmethod.pa_inertia": "Measured how strongly your positive feelings carry over day to day, compared with your own earlier norm.",
  "insights.webmethod.na_inertia": "Measured how strongly your negative feelings carry over day to day, compared with your own earlier norm.",
  "insights.webmethod.energy_mood_coupling": "Measured how much your energy and mood move together, compared with your own earlier norm.",
  "insights.webmethod.sense_making": "Measured how much your writing leans on cause-and-effect and insight words, compared with your own earlier norm.",
  "insights.webmethod.activity_diversity": "Measured the variety of your tagged activities per week, compared with your own earlier weeks.",
  "insights.webmethod.instability": "Measured the size of your day-to-day mood swings, compared with your own earlier norm.",
  "insights.webmethod.mood_shift": "Watched your mood against your personal baseline with a control chart that flags sustained shifts.",
  "insights.webmethod.rumination": "Found a negative thought-phrase that keeps returning in near-identical form.",
  "insights.webmethod.topic": "Found a word or phrase taking up more space in your writing than it used to.",
  "insights.webmethod.recurring_phrase": "Found a phrase that keeps returning in near-identical form.",
  "insights.webmethod.avoidance": "Noticed you tend to go quiet the day after this comes up, compared with your own usual rhythm.",
  "insights.webmethod.cadence": "Compared how regular your writing rhythm is against your own earlier norm.",
  ...
  "login.webNeverLeaves": "Your password never leaves this device. Only a derived verifier is sent — the server cannot read your journal.",
  "login.usernameRuleWeb": "Username: 3–64 characters — letters, digits, dot, dash, underscore.",
  "login.policyMinWeb": "Use at least {min} characters.",
  "login.policyVarietyWeb": "Use at least three of: lowercase, uppercase, digits, symbols (or 16+ characters).",
  "login.policyCommonWeb": "That password is too common or predictable — choose something unique.",
  "login.pwMismatchWeb": "The two passwords do not match.",
  "login.enterPwWeb": "Enter your password.",
  "login.therapistRoleWeb": "This is a therapist account — use the therapist portal instead.",
  "login.invalidResponseWeb": "Sign-in failed — the server sent an invalid response. Try again.",
  ...
  "measures.alreadyToday": "Already recorded today.",
  "measures.saveFailed": "Could not save the measure.",
  ...
  "measures.interpretationNote": "Interpretation belongs to a clinician — this app deliberately shows only your numbers.",
  "measures.loadOffline": "Could not load measures — check your connection.",
  "measures.walkLimit": "The server keeps returning measure pages — aborting the download at its safe limit.",
  "nav.measures": "Measures",
  "nav.share": "Share",
  "nav.privacy": "Privacy",
  "nav.signOutAll": "Sign out (all devices)",
  ...
  "onboarding.webNext": "Next",
  "onboarding.webStep": "Step {current} of {total}",
  "privacy.webTitle": "Privacy, honestly",
  "privacy.webS1": "What this app encrypts: everything you write. Your password derives a key on this device; entries, patterns, questions and measures travel and rest as opaque ciphertext the server cannot read.",
  "privacy.webS2": "What the server does hold: your username, the dates and sizes of entries, and insight dates. A database leak reveals when and how much you wrote — never what.",
  "privacy.webS3": "One deliberate exception: when you press \"Refresh patterns\", your key travels inside a single-use processing session over TLS, is held in memory only, and is destroyed the moment the analysis consumes it.",
  "privacy.webS4": "Sharing with a therapist is opt-in, encrypted end to end, and revocable. Revoking ends access immediately; it cannot unread what was already seen.",
  "privacy.webS5": "Deletion removes you and the full cascade from the live database. Only the access audit log (who read what, when — no content) survives, for accountability.",
  "question.titleWeb": "Today's question",
  "question.noPidNote": "A reflective question from today's writing rhythm — no answer is required.",
  "question.noted": "Noted — it shapes future questions, privately.",
  "question.loadFailed": "Could not load today's question.",
  "question.refreshTitle": "Refresh patterns",
  "question.refreshBody": "Runs the analysis over your encrypted journal. This is the ONLY action that sends your key to the server — inside a single-use session that is destroyed the moment the analysis finishes.",
  "question.refreshing": "Refreshing…",
  "question.refreshPatterns": "Refresh patterns",
  "question.refreshOffline": "Refreshing patterns needs a connection.",
  "question.refreshFailed": "Could not refresh patterns.",
  "question.refreshDone": "Patterns refreshed.",
  "question.refreshBaselineOne": "Baseline updated — {days} active day to go.",
  ...
  "settings.exportOk": "Export downloaded — an encrypted bundle. It stays unreadable without your password (decrypt it offline with the repo's decrypt_export tool).",
  "settings.exportBlocked": "Your browser blocked the download — copy the bundle manually when the dialog opens.",
  ...
  "settings.accessEmpty": "No recorded access beyond your own yet.",
  "settings.showMore": "Show more",
  "settings.rotateTitle": "Change password",
  "settings.rotateNote": "Re-encrypts your entire journal under the new password, re-wraps every therapist grant, and signs out every device — including the mobile app.",
  "settings.newPasswordField": "New password",
  "settings.confirmPasswordField": "Confirm new password",
  ...
  "settings.deleteNote": "Removes you and the full cascade: entries, patterns, questions, measures, sharing grants. Only the access audit log survives (metadata, no content). This cannot be undone.",
  "settings.deleteConfirmLabel": "Type DELETE to confirm",
  "settings.deleteButton": "Delete my account",
  "settings.deleteTypeDelete": "Type DELETE to confirm — this cannot be undone.",
  "settings.deleteDoneNotice": "Your account and everything in it were deleted. Only the access audit log (who read what, when — no content) survives, for accountability.",
  "settings.deleteFailed": "Could not delete the account.",
  "share.webTitle": "Share with a therapist",
  "share.webZeroKnowledge": "Zero-knowledge: your key is wrapped to your therapist's public key — the server never sees it, and neither does anyone else.",
  "share.webPairingCode": "Pairing code",
  "share.webPairingPlaceholder": "from your therapist's portal",
  "share.webLookUp": "Look up",
  "share.webTherapist": "Therapist: {name}",
  "share.webFingerprint": "Their key fingerprint: {fingerprint}",
  "share.webFingerprintWarn": "Read this fingerprint back to your therapist (in the room or on the phone). If it does not match what their portal shows, STOP — a mismatch means the key was substituted.",
  "share.webFingerprintConfirm": "We read the key fingerprint back to each other and it MATCHED. (A substituted key would decrypt nothing — but checking is the only proof the right therapist is on the other end.)",
  "share.webDisclosureConfirm": "I understand: they can read my patterns and the decrypted entries behind them; every read is audit-logged; revoking ends access immediately but cannot unread what has already been seen.",
  "share.webConfirmShare": "Confirm and share",
  "share.webGrantsTitle": "Your grants",
  "share.webNoGrants": "No active grants — your journal is shared with no one.",
  "share.webSince": "{name} ({username}) — since {date}",
  "share.webRevoke": "Revoke access",
  "share.webRevokedList": "Revoked or ended: {names}.",
  "share.webGrantedStatus": "Shared with {name}. They can now see your patterns and the entries behind them, until you revoke.",
  "share.webRevokedStatus": "Revoked — {name} loses access immediately. What they already read cannot be unread.",
  "share.webCodeRule": "Type the pairing code your therapist shows.",
  "share.webCodeExpired": "That code is not valid — codes expire after 15 minutes and work once.",
  "share.webLookupFailed": "Lookup failed.",
  "share.webTermsChanged": "The sharing terms changed — start the pairing again to see the current disclosure.",
  "share.webGrantFailed": "Could not complete sharing.",
  "share.webRevokeFailed": "Could not revoke.",
  "share.webLoadFailed": "Could not load sharing.",
};
